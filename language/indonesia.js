...
➡️ Script ini bisa kalian dapatkan di kanal programming environment: GitHub

🗯️ Boleh saya menambah ke grup?
➡️ Boleh, kalian bisa sewa Bot utk grub kalian... murah koq :)
...
╭─❒ Paket 5   
├ Price: 5K IDR
├ Grub WA join: Not include Group
├ Premium: 1 user premium
├ Valid: 30 day
╰❒

*Payment*
GoPay: 0813-2958-5825
Other Payment?, chat Owner

*Bundle Information*
Price -> Harga
Grub WA join -> Bot join/masuk ke grub WA kamu sesuai bundle yg kamu pilih 
Premium -> nomor user/pengguna akan ditambahkan ke data user premium (pilih dan send nomor yg akan dimasukan ke data premium ke owner, via chat)
*premium user = unlimited limit + unlocks premium feature
Valid -> Masa expired/kedaluarsa Bot sesuai tanggal pembelian

*Guarantee*
Sewa Bot bergaransi, apabila terdapat kendala bug/error/mati pada Bot, harap segera lapor/chat ke Owner
Bot online 24 jam
`
}
exports.welcome = () =>{
